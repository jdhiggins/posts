...
class TestAPI(unittest.TestCase):
    ...
    def testGetPostsWithBody(self):
        ...
        postA = models.Post(title="Post with bells", body="Just a test")
        postB = models.Post(title="Post with whistles", body="Still a test")
        postC = models.Post(title="Post with bells and whistles", body="Still another test")
        
        session.add_all([postA, postB, postC])
        session.commit()
        
        response = self.client.get("/api/posts?body_like=till",
            headers=[("Accept", "application/json")]
        )
    ...
    def testGetPostsWithBodyAndTitle(self):
        ...
        response = self.client.get("/api/posts?body_like=Still&title_like=bells",
            headers=[("Accept", "application/json")]
        )
